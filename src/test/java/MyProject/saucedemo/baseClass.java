...
public class baseClass {
    ...
    //    options.addArguments("--disable-gpu");  // Disable GPU hardware acceleration
        ...
        options.addArguments("user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36");  // Set custom User-Agent
